...
folder_path = os.path.join(os.getcwd(),'images_out_2')
...
def main():
    ...
    cap_2 = cv2.VideoCapture('rtsp://admin:epg_27000@192.168.10.111:554/')# cap = cv2.VideoCapture('/home/lokender/Downloads/orig_faces/videos/nayeem.mp4')
    fno = 0
    det_name = []
    det_prob =[]
    bbs = []
    ...
    while (~(cv2.waitKey(1) & 0xFF == ord('q'))):
        ...
        if nrof_faces == 1:
            ...
            crop_img = img[int(top-60):int(bottom+60), int(left-100):int(right+100)]
