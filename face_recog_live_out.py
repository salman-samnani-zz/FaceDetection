# -*- coding: utf-8 -*-
"""
Created on Thu Mar 12 00:07:40 2020
...
def main():
    ...
    while (~(cv2.waitKey(1) & 0xFF == ord('q'))):
        ...
        ret, image1 = cap.read()
        image2 = cv2.resize(image1, (600, 400))
        ...
        cv2.imshow('Out Camera Live Feed', image2)
        fno = fno + 1
        ...
        image4 = cv2.resize(image3, (320, 240))
...
if __name__ == '__main__':
    while True:
        try:
            ...
            write_error_log('Exception Occured out cam')
            print("Exception-----")