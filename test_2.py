...
folder_path = os.path.join(os.getcwd(),'images_live_stream')
...
def main():
    ...
    while (~(cv2.waitKey(1) & 0xFF == ord('q'))):
        ...
        threshold = [0.5, 0.7, 0.9]  # three steps's threshold
        ...
        if nrof_faces == 1:
            ...
            crop_img = image4[int(top):int(right), int(bottom):int(left)]
            print(image4)
