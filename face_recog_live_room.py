...
folder_path="D:/david/mtcnn-master/images_room/"
#E:\david\mtcnn\images_room
save_pic = 0
ii = 0
...
def main():
    ...
    #cap_2 = cv2.VideoCapture("rtsp://admin:Optus@123@192.168.15.11:554/cam/realmonitor?channel=1&subtype=0")
    ...
    cap_2 = cv2.VideoCapture("rtsp://admin:Epagingadmin@10.194.2.51:554/")# cap = cv2.VideoCapture('/home/lokender/Downloads/orig_faces/videos/nayeem.mp4')
